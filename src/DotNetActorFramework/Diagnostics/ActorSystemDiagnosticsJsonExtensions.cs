...
namespace DotNetActorFramework.Diagnostics
{
    ...
    /// </summary>
    /// <remarks>
    /// This is a static utility class that provides JSON serialization and deserialization methods
    /// for diagnostic data structures used in the actor framework.
    /// </remarks>
    public static class ActorSystemDiagnosticsJsonExtensions
    {
        ...
        /// <exception cref="JsonException">The JSON is malformed and cannot be deserialized.</exception>
