...
namespace DotNetActorFramework.Tests
{
    ...
    public static class ActorMetricsTestsValidation
    {
        ...
        public static IReadOnlyList<string> Validate(this ActorMetricsTests value)
        {
            ...
            const double expectedErrorRate = 50.0;
            ...
            const double expectedSuccessRate = 50.0;
            ...
            const double expectedAvg = 200.0;
            ...
            const double expectedAvgProcTime = 150.0;
        ...
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="value"/> is null.</exception>
        public static bool IsValid(this ActorMetricsTests value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        /// <summary>
        /// Creates a new <see cref="global::DotNetActorFramework.Models.ActorMetrics"/> instance for testing purposes.
        /// </summary>
        /// <param name="pathStr">The actor path string. Defaults to "/system/actor".</param>
        /// <returns>A new ActorMetrics instance.</returns>
